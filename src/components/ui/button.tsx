...
const buttonVariants = cva(
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-sm font-bold ring-offset-background transition-all duration-300 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        default: "bg-primary text-primary-foreground hover:bg-primary/90 hover:shadow-[0_0_20px_hsl(var(--fitness-orange)/0.5)]",
        ...
        hero: "gradient-accent text-foreground font-black text-base hover:scale-105 hover:shadow-[0_0_30px_hsl(var(--fitness-orange)/0.6)] uppercase tracking-wide",
        cta: "bg-primary text-primary-foreground hover:bg-primary/90 hover:shadow-[0_0_25px_hsl(var(--fitness-orange)/0.5)] hover:scale-[1.02]",
      },
      size: {
